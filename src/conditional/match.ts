...
type _ = [
  Test.Expect<$N<List.Every, [ExtendsSchema, RawResponses]>, false>,

  Test.Expect<$N<List.Filter, [ExtendsSchema, RawResponses]>, ValidResponses>,
  ...
  Test.Expect<
    $$<
      [
        ...
        $<
          ...
          $N<
            List.Map,
            [List.Map, [$<Object.At, 'city'>, $<Object.At, 'country'>]]
    ...
    [
      'Summerside, Canada',
      'Essertines-sur-Yverdon, Switzerland',
      'Sviland, Norway'
    ]
