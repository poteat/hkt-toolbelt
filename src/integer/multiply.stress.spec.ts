...
type Multiply_Spec = [
  ...
  Test.Expect<
    $<
      $<Integer.Multiply, -555>,
      $<$<Integer.Multiply, 12345>, $<$<Integer.Multiply, 999>, 999>>
    >,
    -6837778901475
  >,
   ...
   */
  Test.Expect<
    $<$<Integer.Multiply, -123456789>, -123456789>,
    15241578750190521n
  >,
   ...
   */
  Test.Expect<
    $<$<Integer.Multiply, 9007199254740991>, -9007199254740991>,
