 ...
 * a partially-applied type-level function that is expecting two more arguments, a list of types, 
 * and a type specifying the initial argument that will be passed into the partially-applied function,
 ...
 * 
 * @param F A type-level function for a binary operation. 
 ...
 * a partially-applied type-level function that is expecting two more arguments, 
 * a type specifying the initial argument that will be passed into this partially-applied function,
 * and a target list of types, performs a reduce operation (also known as "fold") over the target list,
 * and returns the resulting type. 
 * 
