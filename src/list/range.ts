...
type _$range2<
  ...
  IS_REVERSE extends boolean = Number._$compare<STEP, 0> extends -1 ? true : false,
  STEP_ABS extends Number.Number = Number._$isInteger<STEP> extends true ? Number._$absolute<STEP> : never,
  F extends Kind.Kind<(x: never) => Kind.Kind> = IS_REVERSE extends true ? $<NaturalNumber.SubtractBy, STEP_ABS> : $<NaturalNumber.Add, STEP_ABS>,
  DISTANCE extends Number.Number = NaturalNumber._$subtract<Number._$max<START, STOP>, Number._$min<START, STOP>>,
  COUNT extends Number.Number = NaturalNumber._$divide<DISTANCE, STEP_ABS>,
  VALIDATE extends boolean = IS_REVERSE extends true 
    ? NaturalNumber._$compare<START, STOP> extends 1 | 0 ? true : false
    : NaturalNumber._$compare<START, STOP> extends -1 | 0 ? true : false,
...
export type _$range<
  ...
  STOP extends Number.Number,
  STEP extends Number.Number
> = List._$every<$<Conditional.Extends, true>, [
